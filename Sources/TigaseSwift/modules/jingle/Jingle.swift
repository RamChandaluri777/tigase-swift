...
extension Jingle {
    public class Transport {
        ...
        public class ICEUDPTransport: JingleTransport {
            public static let XMLNS = "in:secure:vaditi:jingle:transports:ice-udp:1";
            ...
            public required convenience init?(from el: Element) {
                ...
                }), fingerprint: Fingerprint(from: el.findChild(name: "fingerprint", xmlns: "in:secure:vaditi:jingle:apps:dtls:0")));
            }
            ...
            public class Fingerprint {
                ...
                public func toElement() -> Element {
                    let fingerprintEl = Element(name: "fingerprint", cdata: value, xmlns: "in:secure:vaditi:jingle:apps:dtls:0");
        ...
        public class RawUDPTransport: JingleTransport {
            ...
            public static let XMLNS = "in:secure:vaditi:jingle:transports:raw-udp:1";
...
extension Jingle {
    public class RTP {
        public class Description: JingleDescription {
            ...
            public required convenience init?(from el: Element) {
                guard el.name == "description" && el.xmlns == "in:secure:vaditi:jingle:apps:rtp:1" else {
                    return nil;
                }
            ...
            public func toElement() -> Element {
                let el = Element(name: "description", xmlns: "in:secure:vaditi:jingle:apps:rtp:1");
            ...
            public class Payload {
                ...
                public class Parameter {
                    ...
                    public convenience init?(from el: Element) {
                        guard el.name == "parameter" &&  (el.xmlns == "in:secure:vaditi:jingle:apps:rtp:1" || el.xmlns == nil), let name = el.getAttribute("name"), let value = el.getAttribute("value") else {
                            return nil;
                        }
                    ...
                    public func toElement() -> Element {
                        return Element(name: "parameter", attributes: ["name": name, "value": value, "xmlns": "in:secure:vaditi:jingle:apps:rtp:1"]);
                    }
                }
                ...
                public class RtcpFeedback {
                    ...
                    public convenience init?(from el: Element) {
                        guard el.name == "rtcp-fb" && el.xmlns == "in:secure:vaditi:jingle:apps:rtp:rtcp-fb:0", let type = el.getAttribute("type") else {
                            return nil;
                        }
                    ...
                    public func toElement() -> Element {
                        let el = Element(name: "rtcp-fb", xmlns: "in:secure:vaditi:jingle:apps:rtp:rtcp-fb:0");
            ...
            public class HdrExt {
                ...
                public convenience init?(from el: Element) {
                    guard el.name == "rtp-hdrext" && el.xmlns == "in:secure:vaditi:jingle:apps:rtp:rtp-hdrext:0", let id = el.getAttribute("id"), let uri = el.getAttribute("uri") else {
                        return nil;
                    }
                ...
                public func toElement() -> Element {
                    let el = Element(name: "rtp-hdrext", xmlns: "in:secure:vaditi:jingle:apps:rtp:rtp-hdrext:0");
                    el.setAttribute("id", value: id);
            ...
            public class SSRCGroup {
                ...
                public convenience init?(from el: Element) {
                    guard el.name == "ssrc-group", el.xmlns == "in:secure:vaditi:jingle:apps:rtp:ssma:0", let semantics = el.getAttribute("semantics") else {
                        return nil;
                    }
                ...
                public func toElement() -> Element {
                    let el = Element(name: "ssrc-group", xmlns: "in:secure:vaditi:jingle:apps:rtp:ssma:0");
            ...
            public class SSRC {
                ...
                public init?(from el: Element) {
                    guard el.name == "source" && el.xmlns == "in:secure:vaditi:jingle:apps:rtp:ssma:0", let ssrc = el.getAttribute("ssrc") ?? el.getAttribute("id") else {
                        return nil;
                    }
                    self.ssrc = ssrc;
                ...
                public func toElement() -> Element {
                    let el = Element(name: "source", xmlns: "in:secure:vaditi:jingle:apps:rtp:ssma:0");
                    el.setAttribute("ssrc", value: ssrc);
